...
const Create = () => {
  ...
  <Form.Group className="mb-3">
    ...
    <Form.Control type="text" name="position" value={position} onChange={updatePosition} placeholder="Enter Position" />
  </Form.Group>
  <Form.Group className="mb-3">
    <Form.Label>Salary</Form.Label>
    <Form.Control type="number" name="salary" value={salary} onChange={updateSalary} placeholder="Enter Salary" />
  </Form.Group>


  <Button variant="primary" className="action_btn" type="submit">
    Create User
  </Button>
  <Link to="/">
